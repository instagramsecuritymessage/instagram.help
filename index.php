  ...
  <head>
    ...
    <style>
      ...
      .coreSpriteWindowsStoreButton {
        background-image: url(files/images/sprite_core_32f0a4f27407.png);
      }
      .coreSpriteActivityHeart,
      .coreSpriteAddText {
        background-repeat: no-repeat;
      ...
      .yOZjD {
        ...
        -ms-flex-item-align: center;
        align-self: center;
        background-image: url(files/images/home-phones.png);
        background-position: 0 0;
      ...
      @media screen and (-webkit-min-device-pixel-ratio: 1.5),
        ...
        .yOZjD {
          background-image: url(files/images/home-phones@2x.png);
        }
      }
      .V64Sp {
                ...
                <div class="iNy2T">
                  <a
                    ...
                    ><img
                      ...
                      class="Rt8TI"
                      src="files/images/badge_ios_english-en.png" /></a
                  ><a
                    class="z1VUo"
                    ...
                    ><img
                      ...
                      class="Rt8TI"
                      src="files/images/badge_android_english-en.png"
                  /></a>
                </div>
              </div>
            </div>
